...
#Set paths
raw_folder_path = Path.cwd().parent / 'data' / 'raw' / 'IBTrACS_NA'
...
# %%
#Create dictonary for storm names for each season
storm_dict = {}

#Loop through each season
for storm_season in range(2000,2004):

    # Create a list to hold storm names
    storm_names = []
